...
public class Main {
  ...
  public static void main(String[] args) throws NumberFormatException, IOException {
    ...
    FileWriter myWriter1 = new FileWriter("output.txt");
      ...
      while (sc.hasNextLine()) {
        ...
        if (inputString.contains("park") && inputString.contains("driver_age")) {
          ...
          if (tempFlag == 0) {
            ...
            myWriter.write("Car with vehicle registeration number " + inputString.split(" ")[1]

                + " has been parked at slot " + newSlotNumber + ".");
        ...
        if (inputString.contains("leave")) {
          ...
          if (parkingSlot[Integer.parseInt(inputString.split(" ")[1])] != null) {
            ...
            myWriter.write("Slot number " + Integer.parseInt(inputString.split(" ")[1])

                + " vacated, the car with vehicle registration number " + carNumber

                + " left the space, the driver of the car was of age " + age + ".");
          ...
          for (Map.Entry<String, Integer> entry1 : hash.entrySet()) {
            ...
            if (entry1.getValue() == age) {
              ...
              myWriter
                  ...
                  .write("For the driver age " + age + " the vehicle registeration number is " + entry1.getKey() + ".");
